...
W tej grze gracz jest małym królikiem, który musi uniknąć rozdeptania
przez inne króliki, a jednocześnie próbować rozdeptać jak najwięcej
przeciwników. Jump & Bump to gra wyłącznie dla wielu graczy -
maksymalnie czterech naraz. Zgromadź własną drużynę i baw się dobrze.
